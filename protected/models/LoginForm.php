		...
		if(!$this->hasErrors()):
			...
			if(!$this->_identity->authenticate()):
                            switch ($this->_identity->errorCode):
                                   case 1: 
                                     $this->addError('username',Yii::t('user', 'INCORRECT_UNAME_PWD'));
                                     break;
                                   case 2:
                                     $this->addError('password',Yii::t('user', 'INCORRECT_UNAME_PWD'));
                                    break;
                                   case 3:
                                     $this->addError('password',Yii::t('user', 'ACCOUNT_DEACTIVATE'));
                                    break;
                                   case 4:
