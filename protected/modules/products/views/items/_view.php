...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('unit_measure_id')); ?>:</b>
	<?php echo CHtml::encode($data->unit_measure_id); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('reorder_limit')); ?>:</b>
	<?php echo CHtml::encode($data->reorder_limit); ?>
	<br />
