...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td style="text-transform:uppercase; text-align:center;font-size: 20px; font-weight:bold; letter-spacing: 1px;" align="center"><?php echo $model->company->name;?></td>
  </tr>
  <tr>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td height="31" align="left" colspan="3" style="border-bottom: solid 1px #000; vertical-align: bottom;font-size: 13px; font-style: italic;">Se&#241;or(es): 
...
<table width="100%" border="1" align="center" cellpadding="0" cellspacing="0">
	...
	<?php foreach($model->quoteProducts as $key=>$product): ?>
    <tr>
		...
		<td align="center" valign="top"><?php echo $product->quantity * $product->quote_price;?></td>
    </tr>
	<?php endforeach; ?>
		</table>
		</td>
  ...
  <tr>
    <td colspan="2" rowspan="3"><table width="100%" align="center"  border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
		...
		<?php echo $model->company->company_rutno;?></td>
        </tr>
      <tr>
        <td>&nbsp;</td>
    ...
    <td rowspan="3">&nbsp;</td>
    <td><?php echo $model->gettotalamt; ?></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  </tr>
