...
<table  border="0" cellspacing="0" class="table table-bordered table-striped" id="list-table" cellpadding="0">
	...
	<tr>		
		...
		<td>	
		<?php
		echo CHtml::ajaxLink(Myclass::t('Send Invoice'), $this->createUrl('/finance/invoice/modal_send_invoice',array('id'=>$invoice->inv_id)), 
				array('success'=>'function(r){$("#modal_send_invoice").html(r).modal("toggle"); return false;}'), 
...
$this->beginWidget('bootstrap.widgets.BootModal', array('id'=>'modal_send_invoice'));  $this->endWidget(); 
?>