...
?>
<h2><?php echo Myclass::t("Paid Invoices");?></h2>
<table  border="0" cellspacing="0" class="table table-bordered table-striped" id="list-table" cellpadding="0">
	...
	<tr>		
		...
		<td>	
		<?php
		echo CHtml::link('<i class="cus-icon-zoom"></i>',array('/finance/invoice/view','id'=>$invoice->inv_id),array('title'=>Myclass::t("View"),'rel'=>'tooltip')); 
		echo "&nbsp;&nbsp;";
...
?>
<?php $this->beginWidget('bootstrap.widgets.BootModal', array('id'=>'modal_send_invoice'));  $this->endWidget(); ?>