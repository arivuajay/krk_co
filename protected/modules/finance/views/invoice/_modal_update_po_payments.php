...
$form=$this->beginWidget('CActiveForm', array(
	    'id'=>'update-po-payment',
	    'action'=>Yii::app()->createUrl('/finance/invoice/modal_update_po_payments', array('id'=>$past_invoice->inv_id)),
...
<div class="modal-body">
    ...
    <div class="control-group">
	<label for="Invoice_past_pay_ref" class="control-label required"><?php echo Myclass::t("Payment Document"); ?> <span class="required">*</span></label>
	<div class="controls">
