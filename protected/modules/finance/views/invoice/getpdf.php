<?php
if($model->inv_scenario == 'salesorder'):
	$order = $model->invSo;
endif;
?>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td style="text-transform:uppercase; text-align:center;font-size: 20px; font-weight:bold; letter-spacing: 1px;" align="center"><?php echo $model->invSo->company->name;?></td>
  </tr>
  <tr>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td height="31" align="left" colspan="3" style="border-bottom: solid 1px #000; vertical-align: bottom;font-size: 13px; font-style: italic;">Se&#241;or(es): <?php echo $model->invSo->company->name;?></td>
  </tr>
  <tr>
    <td width="39%" align="left" height="31" style="border-bottom: solid 1px #000; vertical-align: bottom;font-size: 13px; font-style: italic;">R.U.T.: <?php echo $model->invSo->company->company_rutno;?></td>
    <td width="31%" align="left" height="31" style="border-bottom: solid 1px #000; vertical-align: bottom;font-size: 13px; font-style: italic;">Direcci&#243;n: <?php echo $model->invSo->company->shipping_address; ?></td>
  ...
  <tr>
    <td height="31" style="border-bottom: solid 1px #000; vertical-align: bottom;font-size: 13px; font-style: italic;">Comuna: <?php echo $model->invSo->company->shipping_state; ?></td>
    <td height="31" style="border-bottom: solid 1px #000; vertical-align: bottom;font-size: 13px; font-style: italic;">Ciudad: <?php echo $model->invSo->company->shipping_city; ?></td>
    <td height="31" style="border-bottom: solid 1px #000; vertical-align: bottom;font-size: 13px; font-style: italic;">&nbsp;</td>
  </tr>
  <tr>
    <td height="30" style="border-bottom: solid 1px #000; vertical-align: bottom;font-size: 13px; font-style: italic;">Giro: <?php echo $model->invSo->company->customer_type->customer_type; ?></td>
    <td height="30" style="border-bottom: solid 1px #000; vertical-align: bottom;font-size: 13px; font-style: italic;">Fonos: <?php echo $model->invSo->company->office_phone; ?></td>
    <td height="30" style="border-bottom: solid 1px #000; vertical-align: bottom;font-size: 13px; font-style: italic;">Email: <?php echo $model->invSo->company->email; ?></td>
  </tr>
  <tr>
    <td height="29" style="border-bottom: solid 1px #000; vertical-align: bottom;font-size: 13px; font-style: italic;">Guia despacho n<sup>0</sup> </td>
...
<table width="100%" border="1" align="center" cellpadding="0" cellspacing="0">
	...
	<?php foreach($order->soProducts as $key=>$product): ?>
    <tr>
  ...
  <tr>
    <td colspan="2" rowspan="3"><table width="100%" align="center"  border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <td width="61%" style="border-bottom: solid 1px #000; vertical-align: bottom; border-right: solid 1px #000;"><span style="border-bottom: solid 1px #000; vertical-align: bottom;font-size: 13px; font-style: italic;"><?php echo $model->invSo->company->company_rutno;?></span></td>
        </tr>
      <tr>
        <td>&nbsp;</td>
        <td style="font-size: 10px; font-style: italic;">Fecha:</td>
        <td width="61%" style="border-bottom: solid 1px #000; vertical-align: bottom; border-right: solid 1px #000;">
	    <?php echo $model->invSo->company->company_rutno;?></td>
        </tr>
      <tr>
        <td>&nbsp;</td>
    ...
    <td rowspan="3">&nbsp;</td>
    <td><?php echo $model->invSo->orderdetail->line_total;?></td>
  </tr>
  <tr>
    <td><?php echo $model->invSo->orderdetail->tax;?></td>
  </tr>
  <tr>
    <td><?php echo $model->invSo->orderdetail->total_order_value;?></td>
  </tr>
</table>
<!--FOOTER-->
