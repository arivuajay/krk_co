<div class="create_user">
    <h3><?php echo Myclass::t('Invoice Trail');?></h3>
...
<table  border="0" cellspacing="0" class="table table_order"  cellpadding="0" style="float: right;width: 455px;">
    <tr>				 
	    ...
	    <th><?php echo Myclass::GetSiteSetting('AMOUNT_FORMAT')." ".$soOdetail->total_order_value;?></th>
    </tr>
    <tr>				 
	    <th><?php echo Myclass::t('Paid Invoices Value');?> :</th>
