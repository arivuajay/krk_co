...
<div class="row">
	...
	'enableAjaxValidation'=>true,
            ...
            <div class="box-body">
                        ...
                        <?php echo $form->labelEx($model,'liner_name',  array('class' => 'col-sm-2 control-label')); ?>
                        <div class="col-sm-5">
                        <?php echo $form->textField($model,'liner_name',array('class'=>'form-control','size'=>60,'maxlength'=>255)); ?>
                        <?php echo $form->error($model,'liner_name'); ?>
                        </div>
                    </div>
                        ...
                        <?php echo $form->error($model,'country_id'); ?>
                                        ...
                                        <div class="form-group">
                        <?php echo $form->labelEx($model,'no_of_free_days',  array('class' => 'col-sm-2 control-label')); ?>
                        <div class="col-sm-5">
                        <?php echo $form->textField($model,'no_of_free_days',array('class'=>'form-control')); ?>
                        <?php echo $form->error($model,'no_of_free_days'); ?>
                        </div>
                    </div>
