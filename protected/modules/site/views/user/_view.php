...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('dojoin')); ?>:</b>
	<?php echo CHtml::encode($data->dojoin); ?>
	<br />

	<?php /*
	<b><?php echo CHtml::encode($data->getAttributeLabel('dobirtrh')); ?>:</b>
	<?php echo CHtml::encode($data->dobirtrh); ?>
	<br />
