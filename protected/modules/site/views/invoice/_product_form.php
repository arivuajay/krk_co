    ...
    <div class="box-body" >
        <div class="row">
            ...
            if ($detail_model->inv_det_product_id) {
                ...
                $grade = CHtml::listData(ProductGrade::model()->active()->findAll(array('order' => 'grade_short_name', 'condition' => "product_id = '{$detail_model->inv_det_product_id}'")), 'grade_id', 'grade_short_name');
