...
class PermitController extends Controller
{
	...
	public function actionView($id)
	{
                ...
                if ($export) {
                    ...
                    $mPDF1->Output("Permit_view_{$id}.pdf", EYiiPdf::OUTPUT_TO_DOWNLOAD);
                } else {
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Permit']))
		{
			...
			if($model->save()){
                                Myclass::addAuditTrail("Created Permit successfully.", "user");
                                Yii::app()->user->setFlash('success', 'Permit Created Successfully!!!');
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['Permit']))
		{
			$model->attributes=$_POST['Permit'];
			if($model->save()){
                                Myclass::addAuditTrail("Updated Permit successfully.", "user");
                                Yii::app()->user->setFlash('success', 'Permit Updated Successfully!!!');
                                $this->redirect(array('index'));
                        }
		}
	...
	public function actionIndex()
	{
            ...
            $model = new Permit();
            $searchModel = new Permit('search');
            $searchModel->unsetAttributes();  // clear any default values
            if (isset($_GET['Permit'])) {
                $search = true;
                $searchModel->attributes = $_GET['Permit'];
                $searchModel->search();
            }
	...
	{
		$model=new Permit('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Permit']))
			$model->attributes=$_GET['Permit'];
	 ...
	 * @param Permit $model the model to be validated
	 */
