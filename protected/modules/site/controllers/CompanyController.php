...
class CompanyController extends Controller {
    ...
    public function actionView($id) {
        ...
        if ($export) {
            ...
            $mPDF1->Output("Company_view_{$id}.pdf", EYiiPdf::OUTPUT_TO_DOWNLOAD);
        } else {
    ...
    public function actionCreate() {
        ...
        if (isset($_POST['Company'])) {
            ...
            if ($model->save()) {
                Myclass::addAuditTrail("Created Company successfully.", "user");
                Yii::app()->user->setFlash('success', 'Company Created Successfully!!!');
    ...
    public function actionUpdate($id) {
        ...
        if (isset($_POST['Company'])) {
            $model->attributes = $_POST['Company'];
            if ($model->save()) {
                Myclass::addAuditTrail("Updated Company successfully.", "user");
    ...
    public function actionIndex() {
        ...
        $model = new Company();
        $searchModel = new Company('search');
        $searchModel->unsetAttributes();  // clear any default values
        if (isset($_GET['Company'])) {
            $search = true;
            $searchModel->attributes = $_GET['Company'];
            $searchModel->search();
        }
