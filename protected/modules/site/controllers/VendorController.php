...
class VendorController extends Controller
{
	...
	public function actionView($id)
	{
                ...
                if ($export) {
                    ...
                    $mPDF1->Output("Vendor_view_{$id}.pdf", EYiiPdf::OUTPUT_TO_DOWNLOAD);
                } else {
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Vendor']))
		{
			...
			if($model->save()){
                                Myclass::addAuditTrail("Created Vendor successfully.", "user");
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['Vendor']))
		{
			$model->attributes=$_POST['Vendor'];
			if($model->save()){
                                Myclass::addAuditTrail("Updated Vendor successfully.", "user");
	...
	public function actionIndex()
	{
            ...
            $model = new Vendor();
            $searchModel = new Vendor('search');
            $searchModel->unsetAttributes();  // clear any default values
            if (isset($_GET['Vendor'])) {
                $search = true;
                $searchModel->attributes = $_GET['Vendor'];
                $searchModel->search();
            }
