...
insert  into `tbl_user`(`user_id`,`first_name`,`last_name`,`email_id`,`mobile_no`,`address`,`dojoin`,`dobirtrh`,`status`,`created_at`,`created_by`,`modified_at`,`modified_by`) values (2,'asas','asasas','asasa@fafda.com','4984798798','','2015-08-01','2015-06-22','1','2015-08-08 18:03:08',1,'0000-00-00 00:00:00',NULL);
