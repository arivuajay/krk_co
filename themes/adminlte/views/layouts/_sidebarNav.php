            ...
            'items' => array(
                ...
                array('label' => '<i class="fa fa-briefcase"></i> <span>Import Purchase</span><i class="fa pull-right fa-angle-left"></i>',
                    ...
                    'items' => array(
                        ...
                        array('label' => '<i class="fa fa-user"></i> <span>Bill Entry</span>', 'url' => array('/site/billentry/index')),
...
//                        array('label' => '<i class="fa fa-user"></i> <span>Permit</span>', 'url' => '#'),
                ...
                array('label' => '<i class="fa fa-briefcase"></i> <span>Purchase Report</span><i class="fa pull-right fa-angle-left"></i>',
                    ...
                    'items' => array(
                        ...
                        array('label' => '<i class="fa fa-user"></i> <span>Purchase Balance Sheet</span>', 'url' => array('/site/invoice/companyreport'), 'active' => (Yii::app()->controller->id == 'invoice' && Yii::app()->controller->action->id == 'companyreport')),
                    ),
                ),
            ),
